...
const STATUS_MAP: Record<string, { label: string; fg: string; bg: string; dot: string }> = {
  requested: { label: 'Requested', fg: '#3B4A66', bg: '#E7E2D4', dot: '#7A8699' },
  arrived:   { label: 'Arrived',   fg: '#7A4A0E', bg: '#FBE9C7', dot: '#E8A33D' },
  called:    { label: 'Called',    fg: '#FFFCF5', bg: '#C97A1F', dot: '#C97A1F' },
...
export function StatusChip({ status = 'requested', size = 'md' }: Props) {
