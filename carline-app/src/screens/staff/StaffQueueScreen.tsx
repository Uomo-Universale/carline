...
const styles = StyleSheet.create({
  ...
  typeScroll: { maxHeight: 44, marginBottom: 6 },
  typeWrap: { flexDirection: 'row', gap: 6, paddingHorizontal: 20 },
  filterChip: {
  ...
  gradeScroll: { maxHeight: 40, marginBottom: 10 },
  filterWrap: { flexDirection: 'row', gap: 6, paddingHorizontal: 20 },
  gradeChip: {
    paddingHorizontal: 12, paddingVertical: 5,
    backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#D8C9A8', borderRadius: 20,
  },
