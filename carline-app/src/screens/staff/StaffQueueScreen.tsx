...
const styles = StyleSheet.create({
  ...
  typeScroll: { maxHeight: 48, marginBottom: 8, marginHorizontal: -16, paddingHorizontal: 16 },
  typeWrap: { flexDirection: 'row', gap: 4, paddingRight: 16 },
  filterChip: {
  ...
  gradeScroll: { maxHeight: 44, marginBottom: 10, marginHorizontal: -16, paddingHorizontal: 16 },
  filterWrap: { flexDirection: 'row', gap: 4, paddingRight: 16 },
  gradeChip: {
    paddingHorizontal: 10, paddingVertical: 4,
    backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#D8C9A8', borderRadius: 18,
  },
